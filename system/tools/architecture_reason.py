...
def render_census(c: dict) -> str:
    ...
    out = [
        ...
        "> own list of what it cites. `system/organism/generated/organism-map.json` ⛔ gitignored —",
        "> a generated artefact, not committed to this repo (see `.gitignore`); it IS the citation",
