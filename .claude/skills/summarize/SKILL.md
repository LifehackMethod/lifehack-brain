---
skill: summarize
description: "Brief conversational gist of the most recent response only. Use on \"/summarize\" — distinct from /condense (condenses) and /explain (unpack)."
shape: utility
title: Summarize
version: 1.0
...
**Role:** the gist-reporter — the thinnest of the three re-render skills. Last response only, conversational, no thread recap; does NOT unpack (that's /explain) or preserve-full-substance (that's /condense) — it just gives the gist. One-shot, fully autonomous.
