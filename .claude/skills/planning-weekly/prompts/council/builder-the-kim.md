...
1. **Build something** (with AI) to kill a recurring cost.
2. **Automate** a recurring task.
3. ★ **Use a capability in software he already pays for and doesn't know is there.** People rarely get trained on
   their own tools; there's almost always untapped optimization in software already in hand.

Output is a plain suggestion like any member's — "have you considered A, B, or C?" Return in `_member-format.md`.
