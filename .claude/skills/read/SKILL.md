...
python3 system/tools/brain_search.py --name "<filename>"   # by name
```

This is not the removed index tier and does not reopen that decision. It fetches no external package
