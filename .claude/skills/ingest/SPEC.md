...
| R4 | The MAIN session may not read the reader scratch (`/tmp/rdr`, `/tmp/ingest_body`); sub-agents may | `ingest_gate_enforce.sh:135-143` (Read tool) + `:206-209` (shell) | **HOOK**, fail-closed |
